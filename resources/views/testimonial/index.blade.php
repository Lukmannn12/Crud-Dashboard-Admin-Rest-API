        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <a href="{{ route('testimonial.create') }}" class="bg-blue-500 px-3 py-3 rounded-md text-white font-semibold text-xl">
                        Create
                    </a>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="border px-6 py-4">
                                        <a href="{{ route('testimonial.edit', $item->id)}}" class="inline-block bg-green-500 px-2 py-2 rounded-md text-white">
                                            Edit
                                        </a>

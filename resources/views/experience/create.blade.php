                ...
                <form action="{{ route('experience.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mt-5">
                            ...
                            <input type="text" placeholder="Date" value="{{ old('date') }}" name="date" class="w-full bg-gray-200 text-sm rounded-md">
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" placeholder="Position" value="{{ old('position') }}" name="position" class="w-full bg-gray-200 text-sm rounded-md px-3 py-2">
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" placeholder="Job Description" value="{{ old('jobdesc') }}" name="jobdesc" class="w-full bg-gray-200 text-sm rounded-md px-3 py-2">
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" placeholder="Tag" value="{{ old('tag') }}" name="tag" class="w-full bg-gray-200 text-sm rounded-md px-3 py-2">
                        </div>
                    </div>
